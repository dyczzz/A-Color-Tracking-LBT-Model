...
//    ofstream f_test(charName);
    ...
    double Njet = 0.0;
//    double atlasbin[26] = {5.0, 6.0, 7.0, 8.0, 9.0, 10.0, 12.0, 14.0, 16.0, 18.0, 20.0, 25.0, 30.0, 40.0, 50.0, 60.0, 70.0, 85.0, 100.0, 120.0, 150.0, 200.0, 250.0, 300.0, 400.0, 500.0};
...
//                 jetwanted += 1;
                 ...
                 {                      
                      ...
                      if(constituents[iD].user_index()>0 && constituents[iD].pt()>=LHptflag) LHptflag = constituents[iD].pt();
                      }
                 }
            }
            if ((idflag > 0)&&(ptmax > leadingptcut)) ++jetwanted;
