...
// duplicate for heavy quark
     ifstream f11("tables/ratedata-HQ");
////cccc     ifstream f11("b-tables/ratedata-HQ");
     if(!f11.is_open())
     {
...
////cccc     ifstream f12("b-tables/dNg_over_dt_bD6.dat");
...
////cccc     ifstream fileB("b-tables/distB.dat");
     if(!fileB.is_open()) {
...
////cccc     ifstream fileF("b-tables/distF.dat");
     if(!fileF.is_open()) {
